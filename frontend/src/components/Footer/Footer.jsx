      ...
      <Row>
        ...
        <ListGroup className='footer_quick-links'>
                ...
                <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                  ...
                  <p className='mb-0'>Colombo,Srilanka</p>
                </ListGroupItem>
                <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                  <h6 className='mb-0 d-flex align-items-center gap-2'>
                    <span>
                  ...
                  <p className='mb-0'>dev.ams@gmail.com</p>
                </ListGroupItem>
                <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                  <h6 className='mb-0 d-flex align-items-center gap-2'>
                    <span>
                  ...
                  <p className='mb-0'>+94 115314127</p>
                </ListGroupItem>
        ...
        <Col lg='12' className='text-center pt-5'>
          <p className='copyright'>Copyright {year}, design and develop by ams. All rights reserved.</p>
        </Col>
      </Row>
    </Container>
    </footer>
